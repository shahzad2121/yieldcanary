          ...
          <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none">
            ...
            <section className="mt-6">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                billing period. You will continue to have access until the end of the paid period. Any refund will be prorated
                based on the unused portion of the current billing period (calculated from the effective cancellation date to the end of the paid period).
              </p>
            </section>
