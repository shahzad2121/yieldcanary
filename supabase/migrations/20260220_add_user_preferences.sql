-- User preferences table (key-value per user). Used for welcome banner dismissed,
-- insights section order, and other per-user UI preferences. Keeps users table lean.
