 ...
 *
 * NOTE:
 * Supabase edge functions are deployed per-function. For dashboard deployments, each
 * function often needs a local copy of this file within its own folder.
 * This file remains the "source of truth" in-repo.
 */
 ...
 * IMPORTANT: Only counts successful sends (sent/delivered), so failures can be retried.
 */
